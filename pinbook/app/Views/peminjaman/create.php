...
function toggleAlamat() {
    ...
    // alamat tampil kalau antar
    document.getElementById('alamatBox').style.display =
        (metode === 'antar') ? 'block' : 'none';

    // petugas tampil kalau ambil
    document.getElementById('petugasBox').style.display =
        (metode === 'ambil') ? 'block' : 'none';
}
...
function validasiForm() {
    ...
    // 🔥 hanya ambil yang butuh petugas
    if (metode === 'ambil' && !petugas) {
        alert('Pilih petugas!');
        return false;
    }
